...
Wzizualizujmy sobie najpierw jakie opóźnienia były przy różnych ilościach opadów
...
Nie jest to dziwne więc że korelacja była taka mała a model regresji okazał się nie efektywny. Widzimy z wykresu, że w naszych danych nie ma odpowiedniości: duże jak i małe opóźnienia można spotkać przy przeróżnych opadach.
